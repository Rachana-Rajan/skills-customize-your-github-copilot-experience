...
Build a classic Hangman word-guessing game in Python using strings, loops, conditionals, and user input. The goal is to practice core game loop logic and user interaction.

## 📝 Tasks

### 🛠️ Hangman game core logic
